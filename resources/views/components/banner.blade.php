...
<section class="mx-auto w-11/12 my-10 items-center text-center lg:flex flex-row justify-center">
    <img class="w-full lg:w-8/12 h-96 object-cover mx-auto xl:w-6/12" src="{{asset('storage/'.$internship->thumbnail)}}" alt="">
    <div class="">
        ...
        <p class="text-xs mb-10 w-2/2 lg:w-1/2 mx-auto">{{ $internship->description }}</p>
