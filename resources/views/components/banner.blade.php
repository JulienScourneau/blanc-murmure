<section class="mx-auto w-full items-center text-center lg:flex flex-col justify-center">
  ...
  <div class="flex justify-center">
    ...
    <a class="bg-orange rounded-3xl ml-12 self-center p-2.5 text-white text-xl border-orange hover:bg-white hover:text-orange hover:border-2" href="/en-ce-moment/#stage-et-ateliers">En savoir plus ></a>
  </div>
  @else
  <div class="flex justify-center">
    <h1 class="Title uppercase text-center font-black text-2xl p-2.5 my-6">
      Il n'y a aucun stage en ce moment, aller faire un tour dans
