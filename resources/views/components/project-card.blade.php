@props(['project', 'id'])
<div class="border-1 shadow-lg    bg-greenDuck rounded-2xl lg:mx-2.5 w-full lg:w-4/12 xl:w-2/12">
    ...
    <div class="flex justify-end">
        <button id={{ $project->id }} class="buttonCarousel m-5 text-white hover:underline">Voir plus ></button>
    </div>
</div>
