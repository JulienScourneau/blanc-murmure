...
<div class="mb-8">
    <div class="mx-auto my-6 h-52 w-full lg:w-8/12 group hover:shadow-lg">
        ...
        >
            ...
            <!--    <div class="pl-10 text-white text-xl relative z-50 opacity-0 group-hover:opacity-100 transition-all group-hover:duration-700">{!! $project->description !!}</div>-->
            <!--</div>-->
            <div class="h-full w-full flex flex-col items-left justify-center">
                <h2 class="pl-10 Title uppercase font-black text-white text-xl relative z-50">{{$project->title}}</h2>
                <div class="pl-10 text-white text-xs relative z-50">{!! $project->description !!}</div>
            </div>
        </a>
    </div>
</div>
