...
<div class="w-full mx-auto shadow-lg bg-greenDuck mb-5 rounded-2xl lg:m-5"> 
    <img class="rounded-t-2xl" src="{{$project->thumbnail}}" alt="">
    <div class="text-white p-2.5">
        ...
        <div class="flex justify-around">
            <a class="px-2.5 py-1 bg-orange rounded-full border-2 border-orange hover:bg-white hover:text-orange" href="">Aperçu ></a>
            <a 
                class="px-2.5 py-1 ml-1 bg-orange rounded-full border-2 border-orange hover:bg-white hover:text-orange" 
                href="https://www.publier-un-livre.com/fr/le-livre-en-papier/2125-vertige"
