<div>
    <label class="flex self-start pl-16" for="">Droit à l'image <span class="text-xs font-light pl-1">(01)</span></label>
    <div class="flex w-10/12 mx-auto">
       <div class="border-2 border-placeHolder rounded-full w-10/12 p-2.5">
            ...
            <label for="remember_me">Oui</label>
        </div>
        <div class="border-2 border-placeHolder rounded-full w-10/12 p-2.5 ml-1">
            ...
            <label for="remember_me">Non</label>
        </div>
    </div>
