    ...
    <div class="max-w-lg mx-auto p-4">
        <div class="my-5">
            <div class="flex flex-col"> 
                ...
                <h2 class="Title uppercase text-center font-black text-2xl">Merci de compléter ce formulaire pour toutes inscriptions</h2>
        ...
        <form method="POST" action="{{ route('inscription') }}" class="text-center">
            ...
            <button class="bg-green text-white font-black text-center text-xl rounded-full w-10/12 py-4 mt-9" type="submit">
                {{ucwords("s'inscrire")}}
            </button>
        </form>
        <p class="mt-2.5 mx-auto w-10/12 text-xs font-light text-justify">(1) Les photos prises durant le stage et les vidéos filmées pourraient être utilisées à des fins de communication (édition, exposition, site internet de blanc murmure asbl,…), dans un but culturel et non commercial.</p>
    </div>
@endsection
