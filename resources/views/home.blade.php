...
@section('content')
    ...
    <section class="bg-greenDuck p-2.5 rounded-3xl xl:mx-auto">
        <div class="flex flex-col xl:flex-row xl:w-6/12 mx-auto py-2.5">
            <article class="rounded-2xl items-center border-2 border-white xl:w-4/12 mx-2.5">
            ...
            <article class="mx-auto rounded-2xl items-center border-2 border-white xl:w-4/12 mx-2.5">
